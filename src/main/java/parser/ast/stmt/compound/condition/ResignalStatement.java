 ...
 * @date 2020/7/17
 */
public class ResignalStatement implements SQLStatement {
    private final ConditionValue conditionValue;
    private final List<Pair<Integer, Literal>> informationItems;

    public ResignalStatement(ConditionValue conditionValue, List<Pair<Integer, Literal>> informationItems) {
