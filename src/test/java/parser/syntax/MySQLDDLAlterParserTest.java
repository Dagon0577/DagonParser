...
public class MySQLDDLAlterParserTest extends AbstractSyntaxTest {
    public void testAlterTable() throws Exception {
        ...
        TestCase.assertEquals("ALTER TABLE tb_name", output);
        ...
        TestCase.assertEquals("ALTER TABLE taaaaa ADD COLUMN a int DEFAULT NULL", output);

        sql = "alter table taaaaa add a int after id ".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ADD COLUMN a int DEFAULT NULL AFTER id", output);

        sql = "alter table taaaaa add a int first ".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ADD COLUMN a int DEFAULT NULL FIRST ", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ADD INDEX testIndex(aaaaa)", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ADD KEY index7 USING BTREE (key1) INVISIBLE",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ADD SPATIAL KEY index8(aaaaa) COMMENT 'test'",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ADD CONSTRAINT testKey4 CHECK(a<100) NOT ENFORCED",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 DROP CHECK testKey4", output);

        sql = "alter table test2 alter check testKey4 not ENFORCED;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALTER CHECK testKey4NOT ENFORCED", output);

        sql = "alter tablE test2 ALGORITHM = default".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALGORITHM=DEFAULT", output);

        sql = "alter tablE test2 ALGORITHM = instant".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALGORITHM=INSTANT", output);

        sql = "alter tablE test2 ALGORITHM = inplace".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALGORITHM=INPLACE", output);

        sql = "alter tablE test2 ALGORITHM = COPY".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALGORITHM=COPY", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALTER COLUMN a SET DEFAULT '2'", output);

        sql = "alter table test2 alter column a drop default;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ALTER COLUMN a DROP DEFAULT", output);

        sql = "alter table taaaaa alter index index7 visible;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ALTER INDEX index7 VISIBLE", output);

        sql = "alter table taaaaa alter index index7 invisible;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa ALTER INDEX index7 INVISIBLE", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 CHANGE COLUMN c aa int(10) DEFAULT NULL FIRST ",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 CHANGE COLUMN c aa varchar(45) DEFAULT NULL FIRST ",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 ENABLE KEYS", output);

        sql = "alter table test2 discard tablespace;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 DISCARD TABLESPACE", output);

        sql = "alter table test2 imporT tablespace;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE test2 IMPORT TABLESPACE", output);

        sql = "alter table table1 drop column c;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE table1 DROP COLUMN c", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa DROP INDEX index7", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa DROP FOREIGN KEY testKey3", output);

        sql = "alter table taaaaa drop primary key;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa DROP PRIMARY KEY", output);

        sql = "alter table taaaaa force;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE taaaaa FORCE", output);

        sql = "alter table t3 lock = default;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 LOCK=DEFAULT", output);

        sql = "alter table t3 lock = SHARED;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 LOCK=SHARED", output);

        sql = "alter table t3 lock = EXCLUSIVE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 LOCK=EXCLUSIVE", output);

        sql = "alter table t3 lock = NONE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 LOCK=NONE", output);

        sql = "alter table t3 modify column a char(10) first;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 MODIFY COLUMN a char(10) DEFAULT NULL FIRST ", output);

        sql = "alter table t3 order by a,id,b,c,d;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 ORDER BY a,id,b,c,d", output);

        sql = "alter table t3 order by a;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 ORDER BY a", output);

        sql = "alter table t3 RENAME column a to aa;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 RENAME COLUMN a TO aa", output);

        sql = "alter table t3 rename index index6 to index777;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 RENAME INDEX index6 TO index777", output);

        sql = "alter table t3 rename to ta;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 RENAME TO ta", output);

        sql = "alter table t3 with VALIDATION;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 WITH VALIDATION", output);

        sql = "alter table t3 without VALIDATION;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t3 WITHOUT VALIDATION", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ADD PARTITION( PARTITION p3 VALUES LESS THAN (2000))",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ADD PARTITION( PARTITION P2 TABLESPACE=ts1)", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DROP PARTITION p2", output);

        sql = "alter table t99 drop partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DROP PARTITION p2,p3", output);

        sql = "alter table t99 discard partition p2 TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DISCARD PARTITION p2 TABLESPACE", output);

        sql = "alter table t99 discard partition p2,p3 TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DISCARD PARTITION p2,p3 TABLESPACE", output);

        sql = "alter table t99 discard partition all TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DISCARD PARTITION ALL TABLESPACE", output);

        sql = "alter table t99 import partition p2 TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 IMPORT PARTITION p2 TABLESPACE", output);

        sql = "alter table t99 import partition p2,p3 TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 IMPORT PARTITION p2,p3 TABLESPACE", output);

        sql = "alter table t99 import partition all TABLESPACE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 IMPORT PARTITION ALL TABLESPACE", output);

        sql = "alter table t99 truncate partition p2;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TRUNCATE PARTITION p2", output);

        sql = "alter table t99 truncate partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TRUNCATE PARTITION p2,p3", output);

        sql = "alter table t99 truncate partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TRUNCATE PARTITION ALL", output);

        sql = "alter table t99 COALESCE PARTITION 9;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 COALESCE PARTITION 9", output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ANALYZE PARTITION p2", output);

        sql = "alter table t99 ANALYZE partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ANALYZE PARTITION p2,p3", output);

        sql = "alter table t99 ANALYZE partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ANALYZE PARTITION ALL", output);

        sql = "alter table t99 CHECK partition p2;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CHECK PARTITION p2", output);

        sql = "alter table t99 CHECK partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CHECK PARTITION p2,p3", output);

        sql = "alter table t99 CHECK partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CHECK PARTITION ALL", output);

        sql = "alter table t99 OPTIMIZE partition p2;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 OPTIMIZE PARTITION p2", output);

        sql = "alter table t99 OPTIMIZE partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 OPTIMIZE PARTITION p2,p3", output);

        sql = "alter table t99 OPTIMIZE partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 OPTIMIZE PARTITION ALL", output);

        sql = "alter table t99 REBUILD partition p2;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REBUILD PARTITION p2", output);

        sql = "alter table t99 REBUILD partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REBUILD PARTITION p2,p3", output);

        sql = "alter table t99 REBUILD partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REBUILD PARTITION ALL", output);

        sql = "alter table t99 REPAIR partition p2;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REPAIR PARTITION p2", output);

        sql = "alter table t99 REPAIR partition p2,p3;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REPAIR PARTITION p2,p3", output);

        sql = "alter table t99 REPAIR partition all;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 REPAIR PARTITION ALL", output);

        sql = "alter table t66 REMOVE PARTITIONING;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t66 REMOVE PARTITIONING", output);

        sql = "alter table t99 AUTO_INCREMENT = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 AUTO_INCREMENT=1 ", output);

        sql = "alter table t99 avg_row_length = 1 AUTO_INCREMENT = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 AUTO_INCREMENT=1 AVG_ROW_LENGTH=1 ", output);

        sql = "alter table t99 default character set latin1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DEFAULT CHARACTER SET=latin1 ", output);

        sql = "alter table t99 checksum = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CHECKSUM=1 ", output);

        sql = "alter table t99 checksum 0;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CHECKSUM=0 ", output);

        sql = "alter table t99 default collate = latin1_swedish_ci;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DEFAULT COLLATE=latin1_swedish_ci ", output);

        sql = "alter table t99 comment 'iA1~!@#$%^&*()_+=-[]\\';/.,<>?:\"{}|/*.';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 COMMENT='iA1~!@#$%^&*()_+=-[]\\';/.,<>?:\"{}|/*.' ",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 COMPRESSION='ZLIB' ", output);

        sql = "alter table t99 COMPRESSION 'LZ4';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 COMPRESSION='LZ4' ", output);

        sql = "alter table t99 COMPRESSION = 'NONE';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 COMPRESSION='NONE' ", output);

        sql = "alter table t99 CONNECTION = 'asdasda';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 CONNECTION='asdasda' ", output);

        sql = "alter table t99 DATA directory = '/var/appdata/95/dat';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DATA DIRECTORY='/var/appdata/95/dat' ", output);

        sql = "alter table t99 index directory = '/var/appdata/97/idx';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 INDEX DIRECTORY='/var/appdata/97/idx' ", output);

        sql = "alter table t99  DELAY_KEY_WRITE =0;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DELAY_KEY_WRITE=0 ", output);

        sql = "alter table t99  DELAY_KEY_WRITE 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 DELAY_KEY_WRITE=1 ", output);

        sql = "alter table t99 ENCRYPTION = 'Y';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ENCRYPTION='Y' ", output);

        sql = "alter table t99 encryption  'N';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ENCRYPTION='N' ", output);

        sql = "alter table t99 engine = innodb;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ENGINE=innodb ", output);

        sql = "alter table t99 insert_method = NO;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 INSERT_METHOD=NO ", output);

        sql = "alter table t99 insert_method = first;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 INSERT_METHOD=FIRST ", output);

        sql = "alter table t99 insert_method last;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 INSERT_METHOD=LAST ", output);

        sql = "alter table t99 key_block_size = 9;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 KEY_BLOCK_SIZE=9 ", output);

        sql = "alter table t99 MAX_ROWS =9999;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 MAX_ROWS=9999 ", output);

        sql = "alter table t99 MIN_ROWS = 9;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 MIN_ROWS=9 ", output);

        sql = "alter table t99 PACK_KEYS = 0;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 PACK_KEYS=0 ", output);

        sql = "alter table t99 PACK_KEYS = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 PACK_KEYS=1 ", output);

        sql = "alter table t99 PACK_KEYS = DEFAULT;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 PACK_KEYS=DEFAULT ", output);

        sql = "alter table t99 PASSWORD = 'Abcd1`23';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 PASSWORD='Abcd1`23' ", output);

        sql = "alter table t99 ROW_FORMAT =default;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=DEFAULT ", output);

        sql = "alter table t99 ROW_FORMAT =dynamic;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=DYNAMIC ", output);

        sql = "alter table t99 ROW_FORMAT =fixed;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=FIXED ", output);

        sql = "alter table t99 ROW_FORMAT =compressed;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=COMPRESSED ", output);

        sql = "alter table t99 ROW_FORMAT =redundant;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=REDUNDANT ", output);

        sql = "alter table t99 ROW_FORMAT =compact;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 ROW_FORMAT=COMPACT ", output);

        sql = "alter table t99 STATS_AUTO_RECALC  = default;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_AUTO_RECALC=DEFAULT ", output);

        sql = "alter table t99 STATS_AUTO_RECALC  = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_AUTO_RECALC=1 ", output);

        sql = "alter table t99 STATS_AUTO_RECALC  = 0;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_AUTO_RECALC=0 ", output);

        sql = "alter table t99 STATS_PERSISTENT  = default;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_PERSISTENT=DEFAULT ", output);

        sql = "alter table t99 STATS_PERSISTENT  = 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_PERSISTENT=1 ", output);

        sql = "alter table t99 STATS_PERSISTENT  = 0;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_PERSISTENT=0 ", output);

        sql = "alter table t99 STATS_SAMPLE_PAGES  = 2312;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 STATS_SAMPLE_PAGES=2312 ", output);

        sql = "alter table t99 TABLESPACE p1 storage disk;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TABLESPACE p1 STORAGE DISK ", output);

        sql = "alter table t99 TABLESPACE p2 storage memory;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TABLESPACE p2 STORAGE MEMORY ", output);

        sql = "alter table t99 TABLESPACE p3".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 TABLESPACE p3", output);

        sql = "alter table t99 union = (t1,t2,t3);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 UNION=(t1,t2,t3) ", output);

        sql = "alter table t99 union = (t1);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 UNION=(t1) ", output);

        sql = "alter table t88 PARTITION BY linear hash ((col1-10)*2);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LINEAR HASH((col1-10)*2)", output);

        sql = "alter table t88 PARTITION BY hash ((col1-10)*2);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY HASH((col1-10)*2)", output);

        sql = "alter table t88 partition by linear key (col1,col2);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LINEAR KEY(col1,col2)", output);

        sql = "alter table t88 partition by key (col1,col2);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY KEY(col1,col2)", output);

        sql = "alter table t88 partition by linear key ALGORITHM = 1 (col1);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LINEAR KEY ALGORITHM=1(col1)", output);

        sql = "alter table t88 partition by key ALGORITHM = 1 (col1);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY KEY ALGORITHM=1(col1)", output);

        sql = "alter table t88 partition by RANGE(col1/10);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY RANGE(col1/10)", output);

        sql = "alter table t88 partition by RANGE columns(col1,col2);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY RANGE COLUMNS(col1,col2)", output);

        sql = "alter table t88 partition by LIST(col1*10);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LIST(col1*10)", output);

        sql = "alter table t88 partition by LIST COLUMNS(col1,col2,col3,col4,col5);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LIST COLUMNS(col1,col2,col3,col4,col5)",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 PARTITION BY LIST COLUMNS(col1,col2) PARTITIONS 9",
                output);
        ...
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t99 INSERT_METHOD=NO KEY_BLOCK_SIZE=9 ", output);

        sql = "alter table t88 insert_method = NO ,add b int;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTableStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLE t88 INSERT_METHOD=NO ,ADD COLUMN b int DEFAULT NULL",
                output);
    ...
    public void testAlterDatabase() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DATABASE test CHARACTER SET 'testDb'", output);
        ...
        alter = (DDLAlterDatabaseStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DATABASE test COLLATE 'utf8_bin'", output);

        sql = "ALTER SCHEMA test  COLLATE 'utf8_unicode_ci';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterDatabaseStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DATABASE test COLLATE 'utf8_unicode_ci'", output);

        sql = "ALTER DATABASE test DEFAULT ENCRYPTION = 'Y';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterDatabaseStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DATABASE test DEFAULT ENCRYPTION 'Y'", output);

        sql = "ALTER DATABASE aaaa DEFAULT ENCRYPTION \"n\";".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterDatabaseStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DATABASE aaaa DEFAULT ENCRYPTION 'N'", output);
    ...
    public void testAlterEvent() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER DEFINER='root'@'localhost' EVENT event_name", output);
        ...
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE AT '2006-02-10 23:59:00'", output);
        ...
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 YEAR", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 QUARTER;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 QUARTER", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 MONTH;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 MONTH", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 MINUTE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 MINUTE", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 WEEK;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 WEEK", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 SECOND;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 SECOND", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 YEAR_MONTH;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 YEAR_MONTH", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_HOUR;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_HOUR", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_MINUTE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_MINUTE", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_SECOND;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 DAY_SECOND", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR_MINUTE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR_MINUTE", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR_SECOND;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 HOUR_SECOND", output);

        sql = "ALTER EVENT event_name ON SCHEDULE EVERY 1 MINUTE_SECOND;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON SCHEDULE EVERY 1 MINUTE_SECOND", output);

        sql = "ALTER EVENT event_name RENAME TO new_event_name;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name RENAME TO new_event_name", output);

        sql = "ALTER EVENT event_name ENABLE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ENABLE", output);

        sql = "ALTER EVENT event_name DISABLE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name DISABLE", output);

        sql = "ALTER EVENT event_name DISABLE ON SLAVE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name DISABLE ON SLAVE", output);

        sql = "ALTER EVENT event_name COMMENT 'string';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name COMMENT 'string'", output);

        sql = "ALTER EVENT event_name ENABLE DO UPDATE aaaa.test SET t1 = t1 + 1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ENABLE DO UPDATE aaaa.test SET t1=t1+1",
                output);
        ...
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON COMPLETION PRESERVE", output);

        sql = "ALTER EVENT event_name ON COMPLETION NOT PRESERVE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterEventStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER EVENT event_name ON COMPLETION NOT PRESERVE", output);
    ...
    public void testAlterFunction() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name COMMENT 'string'", output);

        sql = "ALTER FUNCTION func_name LANGUAGE SQL;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name LANGUAGE SQL", output);

        sql = "ALTER FUNCTION func_name CONTAINS SQL;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name CONTAINS SQL", output);

        sql = "ALTER FUNCTION func_name NO SQL;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name NO SQL", output);

        sql = "ALTER FUNCTION func_name READS SQL DATA;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name READS SQL DATA", output);

        sql = "ALTER FUNCTION func_name MODIFIES SQL DATA;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name MODIFIES SQL DATA", output);

        sql = "ALTER FUNCTION func_name SQL SECURITY DEFINER;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name SQL SECURITY DEFINER", output);

        sql = "ALTER FUNCTION func_name SQL SECURITY INVOKER;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name SQL SECURITY INVOKER", output);

        sql = "ALTER FUNCTION func_name COMMENT 'string' LANGUAGE SQL CONTAINS SQL;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name COMMENT 'string' LANGUAGE SQL CONTAINS SQL",
                output);
        ...
        alter = (DDLAlterFunctionStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER FUNCTION func_name NO SQL READS SQL DATA SQL SECURITY DEFINER",
                output);
    }
    ...
    public void testAlterInstance() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER INSTANCE ROTATE INNODB MASTER KEY", output);

        sql = "ALTER INSTANCE ROTATE BINLOG MASTER KEY;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterInstanceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER INSTANCE ROTATE BINLOG MASTER KEY", output);

        sql = "ALTER INSTANCE RELOAD TLS;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterInstanceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER INSTANCE RELOAD TLS", output);

        sql = "ALTER INSTANCE RELOAD TLS NO ROLLBACK ON ERROR;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterInstanceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER INSTANCE RELOAD TLS NO ROLLBACK ON ERROR", output);
    }
    ...
    public void testAlterLogfileGroup() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER LOGFILE GROUP logfile_group ADD UNDOFILE 'file_name'", output);
        ...
        alter = (DDLAlterLogfileGroupStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER LOGFILE GROUP logfile_group ADD UNDOFILE 'file_name' WAIT",
                output);
    ...
    public void testAlterProcedure() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name", output);

        sql = "ALTER PROCEDURE proc_name COMMENT N'a string';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name COMMENT N'a string'", output);

        sql = "ALTER PROCEDURE proc_name COMMENT 'a string';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name COMMENT 'a string'", output);
        ...
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name LANGUAGE SQL", output);

        sql = "ALTER PROCEDURE proc_name contains sql;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name CONTAINS SQL", output);

        sql = "ALTER PROCEDURE proc_name NO SQL;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name NO SQL", output);

        sql = "ALTER PROCEDURE proc_name READS SQL DATA;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name READS SQL DATA", output);

        sql = "ALTER PROCEDURE proc_name modifies sql data;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name MODIFIES SQL DATA", output);

        sql = "ALTER PROCEDURE proc_name SQL SECURITY DEFINER;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name SQL SECURITY DEFINER", output);

        sql = "ALTER PROCEDURE proc_name SQL SECURITY INVOKER;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterProcedureStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER PROCEDURE proc_name SQL SECURITY INVOKER", output);
    ...
    public void testAlterResourceGroup() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER RESOURCE GROUP rg1 VCPU=0-63", output);

        sql = "ALTER RESOURCE GROUP rg1 VCPU = 0,0-64,123;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DALAlterResourceGroupStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER RESOURCE GROUP rg1 VCPU=0,0-64,123", output);

        sql = "ALTER RESOURCE GROUP rg2 THREAD_PRIORITY = 5;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DALAlterResourceGroupStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER RESOURCE GROUP rg2 THREAD_PRIORITY=5", output);

        sql = "ALTER RESOURCE GROUP rg3 DISABLE FORCE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DALAlterResourceGroupStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER RESOURCE GROUP rg3 DISABLE FORCE", output);
    ...
    public void testAlterServer() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (HOST '192.168.174.100')", output);

        sql = "ALTER SERVER server_name OPTIONS(DATABASE 'test');".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterServerStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (DATABASE 'test')", output);

        sql = "ALTER SERVER server_name OPTIONS(USER 'root');".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterServerStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (USER 'root')", output);

        sql = "ALTER SERVER server_name OPTIONS(PASSWORD 'allalala');".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterServerStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (PASSWORD 'allalala')", output);
        ...
        alter = (DDLAlterServerStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (OWNER 'root')", output);

        sql = "ALTER SERVER server_name OPTIONS(PORT 3306);".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterServerStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SERVER server_name OPTIONS (PORT 3306)", output);
    ...
    public void testAlterTablespace() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ADD DATAFILE 'file_name'", output);

        sql = "ALTER TABLESPACE tablespace_name DROP DATAFILE 'file_name';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name DROP DATAFILE 'file_name'", output);

        sql = "ALTER TABLESPACE tablespace_name INITIAL_SIZE = 10G;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name INITIAL_SIZE=10G", output);
        ...
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name WAIT", output);

        sql = "ALTER TABLESPACE tablespace_name RENAME TO tablespace_name;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name RENAME TO tablespace_name", output);

        sql = "ALTER UNDO TABLESPACE tablespace_name SET INACTIVE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER UNDO TABLESPACE tablespace_name SET INACTIVE", output);

        sql = "ALTER UNDO TABLESPACE tablespace_name SET ACTIVE;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER UNDO TABLESPACE tablespace_name SET ACTIVE", output);

        sql = "ALTER TABLESPACE tablespace_name ENCRYPTION = 'Y';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ENCRYPTION='Y'", output);

        sql = "ALTER TABLESPACE tablespace_name ENCRYPTION 'N';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ENCRYPTION='N'", output);

        sql = "ALTER TABLESPACE tablespace_name ENGINE = INNODB;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ENGINE=INNODB", output);

        sql = "ALTER TABLESPACE tablespace_name ENGINE NDB;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ENGINE=NDB", output);
        ...
        alter = (DDLAlterTablespaceStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER TABLESPACE tablespace_name ENCRYPTION='Y' ENGINE=NDB", output);
    }
    ...
    public void testAlterUser() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS user() IDENTIFIED BY 'auth_string'", output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS user() DISCARD OLD PASSWORD", output);

        sql = "ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string';".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string'", output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED WITH auth_plugin", output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon DISCARD OLD PASSWORD", output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string' REQUIRE NONE",
                output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string' REQUIRE SSL",
                output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string' ACCOUNT LOCK",
                output);
        ...
        alter = (DALAlterUserStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER USER IF EXISTS dagon IDENTIFIED BY 'auth_string' ACCOUNT UNLOCK",
                output);
    ...
    public void testAlterView() throws Exception {
        ...
        String output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER VIEW v_today(id,a,b) AS SELECT * FROM t1", output);

        sql = "ALTER ALGORITHM = UNDEFINED VIEW v_today (id,a,b)  AS SELECT * FROM t1;".getBytes();
        tuple = Parser.parse(sql, MySqlCharset.UTF8_FOR_JAVA);
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER ALGORITHM=UNDEFINED VIEW v_today(id,a,b) AS SELECT * FROM t1",
                output);
        ...
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER ALGORITHM=MERGE VIEW v_today(id,a,b) AS SELECT * FROM t1",
                output);
        ...
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER ALGORITHM=TEMPTABLE VIEW v_today(id,a,b) AS SELECT * FROM t1",
                output);
        ...
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SQL SECURITY DEFINER VIEW v_today(id,a,b) AS SELECT * FROM t1",
                output);
        ...
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER SQL SECURITY INVOKER VIEW v_today(id,a,b) AS SELECT * FROM t1",
                output);
        ...
        alter = (DDLAlterViewStatement) tuple._1().get(0);
        output = outputMySQL(alter, sql);
        TestCase.assertEquals("ALTER VIEW v_today(id,a,b) AS SELECT * FROM t1 WITH CHECK OPTION",
                output);
