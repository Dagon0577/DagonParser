...
public class MySQLDMLDeleteParserTest extends AbstractSyntaxTest {
    ...
    public void testDelete() throws Exception {
        ...
        TestCase.assertNotNull(delete);
        String output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE LOW_PRIORITY id1.id,id FROM t1 AS a WHERE col1=?", output);
        ...
        TestCase.assertEquals("DELETE LOW_PRIORITY QUICK IGNORE FROM t1 PARTITION(p1,p2)", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE id1.id FROM t1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE FROM id1.id WHERE col1='adf' LIMIT 10", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE FROM id WHERE col1='adf' ORDER BY d LIMIT 1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE id.* FROM t1,t2 WHERE col1='adf' AND col2=1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE id,id.t FROM t1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE FROM t1 WHERE t1.id1='abc' ORDER BY a LIMIT 5", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE FROM t1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE IGNORE tb1.*,id1.t FROM t1", output);
        ...
        TestCase.assertNotNull(delete);
        output = outputMySQL(delete, sql);
        TestCase.assertEquals("DELETE QUICK tb1.*,id1.t FROM t1", output);
